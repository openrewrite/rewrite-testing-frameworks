...
//                    Arguments.arguments("java.nio.file.Path","assertThat(x.endsWith(\"y\")).isTrue()","assertThat(x).endsWithRaw(\"y\")"),
                    ...
                    ///Related to Array
//                    Arguments.arguments("Object[]","assertThat(x).hasSize(0)","assertThat(x).isEmpty()"),
...
//                    Arguments.arguments("char[]","assertThat(x.length).isGreaterThanOrEqualTo(1)","assertThat(x).hasSizeGreaterThanOrEqualTo(1)"),
                    ...
                    Arguments.arguments("java.util.Collection<String>","assertThat(x).hasSize(0)","assertThat(x).isEmpty()"),
                    ...
                    //Related to Map
                    Arguments.arguments("java.util.Map<String, Object>","assertThat(x).hasSize(0)","assertThat(x).isEmpty()"),
//                    Arguments.arguments("java.util.Map<String, Object>","assertThat(x).hasSize(y.size())","assertThat(x).hasSameSizeAs(y)"),
                    ...
                    Arguments.arguments("java.util.Map<String, Object>","assertThat(x.keySet()).containsOnly(\"a\")","assertThat(x).containsOnlyKeys(\"a\")"),
