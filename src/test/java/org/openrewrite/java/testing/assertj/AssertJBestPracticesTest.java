...
class AssertJBestPracticesTest implements RewriteTest {
    ...
    /**
     * Chained AssertJ assertions should be simplified to the corresponding dedicated assertion, as per
     * <a href="https://next.sonarqube.com/sonarqube/coding_rules?open=java%3AS5838&rule_key=java%3AS5838">java:S5838</a>
     */
    @Nested
    class SonarDedicatedAssertions {
        private static Stream<Arguments> replacements() {
            return Stream.of(
              ...
              arguments("String", "assertThat(x.equalsIgnoreCase(y)).isTrue()", "assertThat(x).isEqualToIgnoringCase(y)"),
              arguments("String", "assertThat(x.contains(y)).isTrue()", "assertThat(x).contains(y)"),
              arguments("String", "assertThat(x.startsWith(y)).isTrue()", "assertThat(x).startsWith(y)"),
              ...
              arguments("java.io.File", "assertThat(x.length()).isEqualTo(3)", "assertThat(x).hasSize(3)"),
              arguments("java.io.File", "assertThat(x.canRead()).isTrue()", "assertThat(x).canRead()"),
              arguments("java.io.File", "assertThat(x.canWrite()).isTrue()", "assertThat(x).canWrite()"),
              arguments("java.io.File", "assertThat(x.exists()).isTrue()", "assertThat(x).exists()"),
              arguments("java.io.File", "assertThat(x.getName()).isEqualTo(\"a\")", "assertThat(x).hasName(\"a\")"),
              arguments("java.io.File", "assertThat(x.getParent()).isEqualTo(\"b\")", "assertThat(x).hasParent(\"b\")"),
              arguments("java.io.File", "assertThat(x.getParentFile()).isNull()", "assertThat(x).hasNoParent()"),
              arguments("java.io.File", "assertThat(x.isAbsolute()).isTrue()", "assertThat(x).isAbsolute()"),
              arguments("java.io.File", "assertThat(x.isAbsolute()).isFalse()", "assertThat(x).isRelative()"),
              arguments("java.io.File", "assertThat(x.isDirectory()).isTrue()", "assertThat(x).isDirectory()"),
              arguments("java.io.File", "assertThat(x.isFile()).isTrue()", "assertThat(x).isFile()"),
              arguments("java.io.File", "assertThat(x.list()).isEmpty()", "assertThat(x).isEmptyDirectory()"),
              //Related to Path
              arguments("java.nio.file.Path", "assertThat(x.startsWith(\"x\")).isTrue()", "assertThat(x).startsWithRaw(\"x\")"),
              arguments("java.nio.file.Path", "assertThat(x.endsWith(\"y\")).isTrue()", "assertThat(x).endsWithRaw(\"y\")"),
              arguments("java.nio.file.Path", "assertThat(x.getParent()).isEqualTo(y)", "assertThat(x).hasParentRaw(y)"),
              arguments("java.nio.file.Path", "assertThat(x.getParent()).isNull()", "assertThat(x).hasNoParentRaw()"),
              arguments("java.nio.file.Path", "assertThat(x.isAbsolute()).isTrue()", "assertThat(x).isAbsolute()"),
              arguments("java.nio.file.Path", "assertThat(x.isAbsolute()).isFalse()", "assertThat(x).isRelative()"),
              ///Related to Array
              ...
              arguments("java.util.Collection<String>", "assertThat(x.isEmpty()).isTrue()", "assertThat(x).isEmpty()"),
              arguments("java.util.Collection<String>", "assertThat(x.size()).isZero()", "assertThat(x).isEmpty()"),
              arguments("java.util.Collection<String>", "assertThat(x.contains(\"f\")).isTrue()", "assertThat(x).contains(\"f\")"),
              arguments("java.util.Collection<String>", "assertThat(x.containsAll(y)).isTrue()", "assertThat(x).containsAll(y)"),
              //Related to Map
              arguments("java.util.Map<String, Object>", "assertThat(x).hasSize(y.size())", "assertThat(x).hasSameSizeAs(y)"),
              arguments("java.util.Map<String, Object>", "assertThat(x.containsKey(\"b\")).isTrue()", "assertThat(x).containsKey(\"b\")"),
              arguments("java.util.Map<String, Object>", "assertThat(x.keySet()).contains(\"b\")", "assertThat(x).containsKey(\"b\")"),
              arguments("java.util.Map<String, Object>", "assertThat(x.keySet()).containsOnly(\"a\")", "assertThat(x).containsOnlyKey(\"a\")"),
              arguments("java.util.Map<String, Object>", "assertThat(x.containsValue(value)).isTrue()", "assertThat(x).containsValue(value)"),
              arguments("java.util.Map<String, Object>", "assertThat(x.values()).contains(value)", "assertThat(x).containsValue(value)"),
              arguments("java.util.Map<String, Object>", "assertThat(x.get(\"a\")).isEqualTo(value)", "assertThat(x).containsEntry(\"a\", value)"),
              //Related to Optional
              arguments("java.util.Optional<Object>", "assertThat(x.isPresent()).isTrue()", "assertThat(x).isPresent()"),
              arguments("java.util.Optional<Object>", "assertThat(x.get()).isEqualTo(value)", "assertThat(x).contains(value)"),
              arguments("java.util.Optional<Object>", "assertThat(x.get()).isSameAs(value)", "assertThat(x).containsSame(value)")
