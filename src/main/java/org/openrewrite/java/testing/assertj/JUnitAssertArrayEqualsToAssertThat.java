...
public class JUnitAssertArrayEqualsToAssertThat extends Recipe {
    ...
    protected TreeVisitor<?, ExecutionContext> getSingleSourceApplicableTest() {
        return new UsesType<>(AssertArrayEqualsToAssertThatVisitor.JUNIT_QUALIFIED_ASSERTIONS_CLASS_NAME, false);
    }
...
class AssertArrayEqualsToAssertThatVisitor extends JavaIsoVisitor<ExecutionContext> {
    static final String JUNIT_QUALIFIED_ASSERTIONS_CLASS_NAME = "org.junit.jupiter.api.Assertions";
        ...
        if (args.size() == 2) {
            method = method.withTemplate(
              JavaTemplate.builder(this::getCursor, "assertThat(#{anyArray()}).containsExactly(#{anyArray()});")
                ...
                .javaParser(JavaParser.fromJavaVersion().classpathFromResources(ctx, "assertj-core-3.24.2"))
                .build(),
