...
public class RemoveNotMatcher extends Recipe {
    @Override
    public String getDisplayName() {
        return "Remove Hamcrest `not(Matcher)`";
    }

    @Override
    public String getDescription() {
        return "Remove Hamcrest `not(Matcher)` ahead of migration.";
    }
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new RemoveNotMatcherVisitor();
    }

    public boolean getLogicalContext(J.MethodInvocation mi, ExecutionContext ctx) throws InvalidParameterException {
    ...
    public static class RemoveNotMatcherVisitor extends JavaIsoVisitor<ExecutionContext> {
        @Override
